...
projection into Titan' display, approval bridging, transcript projection into
...
"codex_app_server"`. Titan' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def initialize(
        self,
        client_name: str = "Titan",
        client_title: str = "Titan Agent",
