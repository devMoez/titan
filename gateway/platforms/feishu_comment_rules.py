...
Config: ~/.Titan/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.Titan/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_Titan_home()`` helper (Titan_HOME-aware and
...
RULES_FILE = get_Titan_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_Titan_home() / "feishu_comment_pairing.json"
