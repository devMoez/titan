...
``_check_spotify_available()`` — when the user has not run ``Titan auth
spotify``, the tools remain registered (so they appear in ``Titan
...
The Spotify auth flow (``Titan auth spotify``), CLI plumbing, and docs
