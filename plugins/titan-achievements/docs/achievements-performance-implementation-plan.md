# Titan Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.Titan/plugins/Titan-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.Titan/plugins/Titan-achievements/scan_checkpoint.json`.
