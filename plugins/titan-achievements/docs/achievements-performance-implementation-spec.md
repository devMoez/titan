# Titan Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.Titan/plugins/Titan-achievements/state.json` (existing unlock state)
  - `~/.Titan/plugins/Titan-achievements/scan_snapshot.json` (new)
  - `~/.Titan/plugins/Titan-achievements/scan_checkpoint.json` (new)
