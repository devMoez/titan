...
def worker_loop(worker_id: int, Titan_home: str, result_file: str) -> None:
...
def reclaimer_loop(Titan_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="Titan_mixed_stress_")
    print(f"Titan_HOME = {home}")
