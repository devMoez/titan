...
def _enable_managed_nous_tools(monkeypatch):
    ...
    Titan_cli.auth and Titan_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("Titan_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("Titan_cli.models.check_nous_free_tier", lambda: False)
