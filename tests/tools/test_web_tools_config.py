...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_Titan_home_override(self, tmp_path):
        """Auth lookup should read from Titan_HOME/auth.json, not ~/.Titan/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".Titan").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``Titan tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
