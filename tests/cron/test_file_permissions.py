...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("Titan_cli.config.get_config_path", return_value=config_path), \
             patch("Titan_cli.config.ensure_Titan_home"):
    ...
    def test_ensure_Titan_home_sets_0700(self):
        home = Path(self.tmpdir) / ".Titan"
        with patch("Titan_cli.config.get_Titan_home", return_value=home):
