"""Tests for `Titan curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import Titan_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated Titan_HOME with real agent-created skills on disk."""
    home = tmp_path / ".Titan"
    skills = home / "skills"
    ...
    from Titan_cli import curator as curator_cli
