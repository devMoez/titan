"""Tests for the kanban CLI surface (Titan_cli.kanban)."""
...
from Titan_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from Titan_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_run_slash_board_override_restores_prior_env(kanban_home, monkeypatch):
    ...
    monkeypatch.setenv("Titan_KANBAN_BOARD", "beta")

    kc.run_slash("--board alpha list")

    assert os.environ.get("Titan_KANBAN_BOARD") == "beta"
