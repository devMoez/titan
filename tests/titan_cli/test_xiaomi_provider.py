...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from Titan_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in Titan_OVERLAYS
        overlay = Titan_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify Titan doctor recognizes Xiaomi env vars."""
