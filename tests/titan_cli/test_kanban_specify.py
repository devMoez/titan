"""Tests for the specifier module + `Titan kanban specify` CLI surface.
...
from Titan_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `Titan kanban …` argparse surface directly."""
