...
The main() function in Titan_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `Titan -c model`
...
def _build_parser():
    """Build a minimal replica of the Titan top-level parser."""
