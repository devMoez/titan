"""Tests for the interactive session browser (`Titan sessions browse`).
...
from Titan_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """Titan sessions browse should be parseable."""
        from Titan_cli.main import main as _main_entry
