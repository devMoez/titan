...
Trust levels:
  - builtin:   Ships with Titan. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.Titan/\.env|\~/\.Titan/\.env',
     "Titan_env_access", "critical", "exfiltration",
     "directly references Titan secrets file"),
    ...
    (r'\.Titan/config\.yaml|\.Titan/SOUL\.md',
     "Titan_config_mod", "critical", "persistence",
     "references Titan configuration files directly"),
