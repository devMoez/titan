...
One ``CDPSupervisor`` runs per Titan ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "Titan-dialog-bridge.invalid"
...
(() => {
  if (window.__TitanDialogBridgeInstalled) return;
  window.__TitanDialogBridgeInstalled = true;
  const ENDPOINT = "http://Titan-dialog-bridge.invalid/";
