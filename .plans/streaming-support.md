# Streaming LLM Response Support for Titan Agent
...
```
Titan_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("Titan_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `Titan_cli/config.py` | 1 | +streaming config defaults |
