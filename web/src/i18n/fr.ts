...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateTitan: "Mettre à jour Titan",
    updatingTitan: "Mise à jour de Titan…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Titan (parité avec `Titan plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.Titan/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.Titan/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.Titan/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Titan Achievements",
      subtitle:
        "Badges Titan à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Titan en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Titan davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Titan détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Titan analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Titan Agent ☤",
    },
  },
  kanban: {
