...
const STORAGE_KEY = "Titan-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `Titan_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "Titan-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-Titan-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-Titan-theme-font", "true");
