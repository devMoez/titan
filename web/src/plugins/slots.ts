 ...
 * `window.__Titan_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Titan brand in the top bar
 ...
 *  `window.__Titan_PLUGINS__.registerSlot(...)`.
 *
