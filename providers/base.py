...
def _profile_user_agent() -> str:
    """Return a ``Titan-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from Titan_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"Titan-cli/{_ver}"
    except Exception:
        return "Titan-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # Titan-cli UA so the catalog endpoint is reachable.
