#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Titan docs site.
...
Both publish at:
  https://titan-agent.nousresearch.com/docs/llms.txt
  https://titan-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://titan-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Titan as a Python Library", None),
        ("guides/use-mcp-with-Titan", "Use MCP with Titan", None),
        ("guides/use-voice-mode-with-Titan", "Use Voice Mode with Titan", None),
        ("guides/use-soul-with-Titan", "Use SOUL.md with Titan", None),
        ("guides/build-a-Titan-plugin", "Build a Titan Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Titan"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "titan-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/titan-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Titan Agent — Full Documentation\n",
        (
            "This file is the entire Titan Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Titan, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://titan-agent.nousresearch.com/docs\n",
        "Short index: https://titan-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
