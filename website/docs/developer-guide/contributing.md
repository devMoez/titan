...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Titan Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Titan Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Titan core? Start with [Build a Titan Plugin](../guides/build-a-Titan-plugin.md)
- Building a new built-in core tool for Titan itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.Titan/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.Titan` — use `get_Titan_home()` from `Titan_constants` for code paths and `display_Titan_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/titan-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/titan-agent/blob/main/LICENSE).
