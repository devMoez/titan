...
Set your Tenor API key in your environment (add to `~/.Titan/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/titan-agent/blob/main/skills/media/gif-search/url)`
