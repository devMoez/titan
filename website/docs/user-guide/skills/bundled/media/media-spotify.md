...
Control the user's Spotify account via the Titan Spotify toolset (7 tools). Setup guide: https://titan-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `Titan auth spotify` again.
