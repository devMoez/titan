...
```bash
python3 -m pyfiglet "Titan" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=Titan&font=Slant" | boxes -d stone
```
