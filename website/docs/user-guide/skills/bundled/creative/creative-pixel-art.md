...
```python
import sys
sys.path.insert(0, "/home/teknium/.Titan/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.Titan/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Titan installs package this)
