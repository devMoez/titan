...
| | |
|---|---|
| Source | Optional — install with `Titan skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Titan Agent |
| License | MIT |
...
import upstream classes into Titan itself.
...
```bash
mkdir -p ~/.Titan/cache/darwinian-evolver && cd ~/.Titan/cache/darwinian-evolver
...
```bash
cd ~/.Titan/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.Titan/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.Titan/skills/research/darwinian-evolver
DE_DIR=~/.Titan/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Titan core.
   Custom driver scripts under `~/.Titan/skills/...` are user-side and fine.
