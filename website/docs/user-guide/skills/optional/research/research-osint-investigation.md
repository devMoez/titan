...
| | |
|---|---|
| Source | Optional — install with `Titan skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Titan Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $Titan_OSINT_CACHE/icij/ (default: ~/.cache/Titan-osint/icij/).
...
# Set Titan_OSINT_UA=your-app/1.0 (your@email) to identify yourself
