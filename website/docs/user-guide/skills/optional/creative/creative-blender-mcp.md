---
title: "Blender Mcp — Control Blender directly from Titan via socket connection to the blender-mcp addon"
sidebar_label: "Blender Mcp"
description: "Control Blender directly from Titan via socket connection to the blender-mcp addon"
---
...
| | |
|---|---|
| Source | Optional — install with `Titan skills install official/creative/blender-mcp` |
