...
| | |
|---|---|
| Source | Optional — install with `Titan skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Titan Agent |
| License | MIT |
...
```
SCRIPT=~/.Titan/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.Titan/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
