...
| | |
|---|---|
| Source | Optional — install with `Titan skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Titan Agent |
| License | MIT |
...
Helper script path: `~/.Titan/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.Titan/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.Titan/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.Titan/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
