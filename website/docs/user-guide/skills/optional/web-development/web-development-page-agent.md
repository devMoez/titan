...
- User wants **Titan itself to drive a browser** → use Titan' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
