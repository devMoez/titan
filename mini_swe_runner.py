#!/usr/bin/env python3
"""
SWE Runner with Titan Trajectory Format

A runner that uses titan-agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the titan-agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses titan-agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Titan format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches titan-agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using titan-agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Titan Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses titan-agent's built-in execution environments
    and outputs trajectories in titan-agent format.
    """
    ...
    def _convert_to_Titan_format(
        ...
        """
        Convert internal message format to Titan trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Titan trajectory format
        trajectory = self._convert_to_Titan_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Titan trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Titan Trajectory Format")
    print("=" * 60)
