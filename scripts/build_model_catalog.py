#!/usr/bin/env python3
"""Build the Titan Model Catalog — a centralized JSON manifest of curated models.
...
Titan CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Titan release.
...
# Ensure Titan_HOME is set for imports that touch it at module level.
os.environ.setdefault("Titan_HOME", os.path.join(os.path.expanduser("~"), ".Titan"))

from Titan_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "titan-agent repo",
            "docs": "https://titan-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
