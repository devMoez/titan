...
DEFAULT_DATASETS = [
    ...
    "NousResearch/titan-agent-megascience-sft1",
    "NousResearch/titan-agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/titan-agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-titan-agent"
]
