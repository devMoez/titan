"""Titan CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.Titan/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Titan Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Titan "       # Response box header label
...
.. code-block:: python
    ...
    from Titan_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Titan Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.Titan/skins/
...
Drop a YAML file in ``~/.Titan/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces titan_agent_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces Titan_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Titan — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Titan Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Titan ",
            "prompt_symbol": "❯",
...
[dim #153C73]⠀⠀⠀⠀⠀⠀⠀deep waters hold⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "sisyphus": {
        ...
        "colors": {
            "banner_border": "#8B8680",
            "banner_title": "#D4CCBF",
            "banner_accent": "#A9A39A",
            "banner_dim": "#6B6460",
            "banner_text": "#E8E4DC",
            "ui_accent": "#A9A39A",
            "ui_label": "#D4CCBF",
            ...
            "prompt": "#E8E4DC",
            "input_rule": "#8B8680",
            "response_border": "#A9A39A",
            "status_bar_bg": "#202020",
            "status_bar_text": "#E8E4DC",
            "status_bar_strong": "#D4CCBF",
            "status_bar_dim": "#8B8680",
            "status_bar_good": "#6eb575",
            "status_bar_warn": "#A9A39A",
            "status_bar_bad": "#8B8680",
            "status_bar_critical": "#f26d6d",
            "session_label": "#D4CCBF",
            "session_border": "#8B8680",
        },
        "spinner": {
            "waiting_faces": ["(◉)", "(◌)", "(◬)", "(⬤)", "(::)"],
            "thinking_faces": ["(◉)", "(◬)", "(◌)", "(○)", "(●)"],
...
[dim #4A4A4A]⠀⠀⠀⠀⠀⠀⠀⠀⠀the boulder⠀⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "charizard": {
        ...
        "colors": {
            ...
            "status_bar_dim": "#E89B3C",
            "status_bar_good": "#6eb575",
            "status_bar_warn": "#F29C38",
            "status_bar_bad": "#C75B1D",
            "status_bar_critical": "#f26d6d",
            "session_label": "#FFF0D4",
            "session_border": "#E89B3C",
        },
        "spinner": {
            "waiting_faces": ["(✦)", "(▲)", "(◇)", "(<>)", "(🔥)"],
            "thinking_faces": ["(✦)", "(▲)", "(◇)", "(⌁)", "(🔥)"],
