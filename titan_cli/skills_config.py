"""
Skills configuration for Titan Agent.
`Titan skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.Titan/config.yaml under:
...
from Titan_cli.config import cfg_get, load_config, save_config
from Titan_cli.colors import Colors, color
from Titan_cli.platforms import PLATFORMS as _PLATFORMS
