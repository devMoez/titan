...
Usage:
    Titan pairing list              # Show all pending + approved users
    Titan pairing approve <platform> <code>  # Approve a pairing code
    Titan pairing revoke <platform> <user_id> # Revoke user access
    Titan pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle Titan pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: Titan pairing {list|approve|revoke|clear-pending}")
        print("Run 'Titan pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.Titan/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'Titan pairing list' to see pending codes.\n")
